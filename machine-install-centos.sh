...
$HOME/apps/miniconda/bin/conda env create --file=$HOME/projects/linux-configs/conda-envs/notebook-environment.yml
...
#cp $HOME/projects/linux-configs/conda-envs/activate-env_vars.sh $HOME/apps/miniconda/envs/notebook/etc/conda/activate.d/env_vars.sh
#cp $HOME/projects/linux-configs/conda-envs/deactivate-env_vars.sh $HOME/apps/miniconda/envs/notebook/etc/conda/deactivate.d/env_vars.sh
