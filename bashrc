...
# Git status function definitions!
...
if [ "$color_prompt" = yes ]; then
    ...
    #PS1="${debian_chroot:+($debian_chroot)}\[\033[38;05;203m\]\u\[\033[00m\]@\[\033[38;05;42m\]\h\[\033[00m\]:\[\033[38;5;180m\]\w\[\033[00m\]\`parse_git_branch\`\$ "
...
# Cling path
export PATH=$HOME/apps/cling_2017-10-11_ubuntu16/bin:$PATH
